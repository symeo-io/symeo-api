...
export class addEnvironmentAccess1676909322836 implements MigrationInterface {
  name = 'addEnvironmentAccess1676909322836';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."environment_access_role_enum" AS ENUM('readNonSecret')`,
    );

    await queryRunner.query(
      `CREATE TABLE "environment-accesses"
             (
                 "createdAt"             TIMESTAMP WITH TIME ZONE                NOT NULL DEFAULT now(),
                 "updatedAt"             TIMESTAMP WITH TIME ZONE                NOT NULL DEFAULT now(),
                 "id"                    uuid                                    NOT NULL DEFAULT uuid_generate_v4(),
                 "userVcsId"             integer                                 NOT NULL,
                 "environmentAccessRole" "public"."environment_access_role_enum" NOT NULL DEFAULT 'readNonSecret',
